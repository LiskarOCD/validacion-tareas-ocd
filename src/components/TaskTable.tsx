...
export const TaskTable: React.FC<TaskTableProps> = ({
  ...
  /*
   * Cuando cambian los filtros o cambia la cantidad de registros,
  ...
  /*
   * Solo calculamos los 50 registros que realmente
   * se van a mostrar.
   */
  ...
  if (tasks.length === 0) {
    return (
      <div className="bg-white rounded-xl border border-[#D5E5ED] p-12 text-center shadow-xs">
        ...
        <h3 className="text-base font-bold text-[#0B2F5B]">
          No se encontraron tareas registradas
        </h3>

        <p className="text-xs text-slate-500 max-w-md mx-auto mt-1">
          No hay tareas comerciales que coincidan con los
          filtros seleccionados o el criterio de búsqueda
          en este circuito.
        </p>
      </div>
    );
  ...
  /*
   * Páginas que mostramos en el navegador.
   */
  ...
  return (
    <div className="bg-white rounded-xl border border-[#D5E5ED] shadow-xs overflow-hidden">
      ...
      <div className="px-4 py-2 bg-white border-b border-[#EBF3F7] flex items-center justify-between text-[11px] text-slate-500">
        ...
        <span>
          Mostrando{' '}
          <strong className="text-[#0B2F5B]">
            {firstVisible.toLocaleString('es-AR')}
          </strong>
          {' '}a{' '}
          <strong className="text-[#0B2F5B]">
            {lastVisible.toLocaleString('es-AR')}
          </strong>
          {' '}de{' '}
          <strong className="text-[#0B2F5B]">
            {tasks.length.toLocaleString('es-AR')}
          </strong>
        </span>
        ...
        <table className="w-full text-left text-xs text-slate-600">
          ...
          <tbody className="divide-y divide-[#EBF3F7]">
            ...
            {visibleTasks.map((task) => {
              ...
              const hasAppealEvidence =
                Boolean(
                  task.evidenciaApelacionUrl ||
                  task.evidenciaApelacionBase64
                );
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3 px-3 whitespace-nowrap">
                    ...
                    <div className="font-bold text-[#181B1E]">
                      {task.fechaTarea}
                    </div>

                    <div className="text-[10px] font-mono text-[#2B98BA] font-semibold">
                      {task.id}
                    </div>
                  ...
                  <td className="py-3 px-3">
                    ...
                    <div className="font-bold text-[#181B1E] line-clamp-1">
                      {task.nombrePDV}
                    </div>
          ...
          {currentPage > 3 && (
            <>
              <button
                type="button"
                onClick={() => goToPage(1)}
                className="w-8 h-8 rounded-lg text-xs font-bold text-[#0B2F5B] hover:bg-[#EBF7FA]"
              >
                1
              </button>
